...
class AnalysisTextForm(forms.ModelForm[Incident]):
    class Meta:
        model = Incident
        fields = [
            "incident_report",
    ...
    def __init__(self, *args: Any, **kwargs: Any):
        ...
        self.fields[
            ...
            "Notes that will be visible only to people editing this incident on this website."
        )


class ReportTextForm(forms.ModelForm[Incident]):
    class Meta:
        model = Incident
        fields = [
            "incident_report",
...
class BaseIncidentForm(forms.ModelForm[Incident]):
    class Meta:
        model = Incident
        fields = [
            "date",
        ...
        widgets = {
            ...
            "incident_type_2": forms.ChoiceField(),
            "incident_type_3": forms.ChoiceField(),
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.fields[
            "editing_notes"
        ].help_text = "Any notes that may be relevant to editors. These notes are private."

        assert isinstance(self.fields["incident_type"], forms.ChoiceField)
        ...
        **kwargs: Any,
        ...
        self.helper.layout = Layout(
            Div(
                ...
                CustomCheckbox("approximate_date", wrapper_class="col-lg-6 checkbox-adjust-down"),
                css_class="row my-0",
            ),
            HTML("<hr>"),
            Div(
...
class ApproveIncidentDateForm(forms.ModelForm[Incident]):
    class Meta:
        model = Incident
        fields = [
            "date",
...
class ApproveReportTextForm(forms.ModelForm[Incident]):
    class Meta:
        model = Incident
        fields = [
            "incident_report",
...
class ApproveMetadataForm(forms.ModelForm[Incident]):
    class Meta:
        model = Incident
        fields = [
            "cave",
...
class ApproveFlagsForm(forms.ModelForm[Incident]):
    class Meta:
        model = Incident
        fields = [
            "fatality",
...
class InjuredCaverForm(forms.ModelForm[InjuredCaver]):
    class Meta:
        model = InjuredCaver
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if not self.incident:
            raise ValueError("Incident must be provided.")
