...
def update_us_state_on_incident(apps: Any, _: Any,) -> None:
...
def process_us_state(states_index: dict[str, str], i: Incident,) -> None:
    if i.us_state:
        return
...
def update_country_on_incident(apps: Any, _: Any,) -> None:
    incident = apps.get_model("db", "Incident")
...
def process_country(index: dict[str, str], i: Incident,) -> None:
    country = i.country
...
def update_incident_category(apps: Any, _: Any,) -> None:
    incident = apps.get_model("db", "Incident")
