...
def convert_category_to_new_choices(apps: Any, schema_editor: Any,) -> None:
...
def convert_aid_type_to_new_choices(apps: Any, schema_editor: Any,) -> None:
    Incident = apps.get_model("db", "Incident")
...
def convert_group_type_to_new_choices(apps: Any, schema_editor: Any,) -> None:
    Incident = apps.get_model("db", "Incident")
...
def convert_source_to_new_choices(apps: Any, schema_editor: Any,) -> None:
    Incident = apps.get_model("db", "Incident")
...
def convert_incident_type_to_new_choices(apps: Any, schema_editor: Any,) -> None:
    Incident = apps.get_model("db", "Incident")
